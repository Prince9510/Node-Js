          ...
          <div className="mb-4">
            ...
            {!otpSent && (
              <button
                ...
                className="mt-2 w-full py-2 px-4 bg-indigo-600 text-white font-semibold rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50"
              >
                Send OTP
              </button>
            )}
